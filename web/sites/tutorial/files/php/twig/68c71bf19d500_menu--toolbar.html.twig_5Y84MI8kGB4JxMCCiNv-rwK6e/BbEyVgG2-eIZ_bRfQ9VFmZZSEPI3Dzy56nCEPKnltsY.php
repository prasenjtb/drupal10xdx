...
class __TwigTemplate_9e4dbdccbc3d23960d95d7589b661901 extends Template
{
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    yield "      <ul";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["toolbar-menu"], "method", false, false, true, 33), "html", null, true);
                    yield ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/stable9/templates/navigation/menu--toolbar.html.twig", "C:\\wamp64330\\www\\drupal10x\\web\\core\\themes\\stable9\\templates\\navigation\\menu--toolbar.html.twig");
    }
