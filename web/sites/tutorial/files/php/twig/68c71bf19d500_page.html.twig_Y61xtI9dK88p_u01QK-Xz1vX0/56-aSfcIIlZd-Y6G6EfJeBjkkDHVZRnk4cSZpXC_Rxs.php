...
class __TwigTemplate_4159d56260c810f17203d87598f489be extends Template
{
    ...
    ";
      ...
      ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 106)) {
          ...
          ";
            // line 108
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 108), "html", null, true);
            yield "
        </div>
      ";
        }
      ...
      ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 114)) {
          ...
          ";
            // line 116
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 116), "html", null, true);
            yield "
        </div>
      ";
        }
...
";
  ...
  <div class=\"";
    ...
    ";
            // line 127
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 127), "html", null, true);
            yield "
  </div>
</footer>
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/layout/page.html.twig", "C:\\wamp64330\\www\\drupal10x\\web\\themes\\contrib\\bootstrap5\\templates\\layout\\page.html.twig");
    }
